      ...
      >
        <div className='relative z-10 text-center px-4 sm:px-6 md:px-8 py-12 font-Bricolage'>
          ...
          <span className='block text-lg md:text-xl max-w-4xs mx-auto mt-4 text-yellow-400'>
            At <strong>Tanvi Premium</strong>, we offer more than just a place
            to stay — we create experiences defined by comfort, care, and
            heartfelt hospitality. Whether you're traveling for business or
            leisure, our commitment is to make every moment memorable. With
            personalized service, modern amenities, and a warm, welcoming
            atmosphere, we strive to feel like home — and better.
            <br />
            <br />
