      ...
      <div className='max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-stretch'>
        ...
        <div className='flex flex-col items-center justify-center bg-yellow-50 rounded-3xl shadow-lg border border-yellow-300 p-10 max-w-md mx-auto text-center'>
          ...
          <p className='text-yellow-900 text-base leading-relaxed'>
            With extensive experience in the hospitality industry, Mr. Mukesh
            Rajput leads our operations with a focus on excellence, efficiency,
            and guest satisfaction. His expertise ensures the smooth, day-to-day
            functioning of our hotels and resorts, all while upholding the
            highest standards of service and comfort for every guest.
          </p>
        </div>
      </div>
    </section>
